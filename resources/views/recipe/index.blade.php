...
@section('search')
<form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0" method="GET" action="/recipe-search"
    role="search">
...
<div id="layoutSidenav_content">
    <main>
        ...
        <div class="container">
                    ...
                    <table class="table table-borderless m-2">
                        <tr class="table-borderless">
                            <td class="row flex-row justify-content-between pr-4 pt-1 pb-1">
                                ...
                                <div class="mb-2">
                                {{ Str::words($recipe->description,10,'...')}}
                                </div>
                               <div class="actions">
            ...
            @endforeach
            <div class="my-2">{{ $recipes->links() }}</div>
            <div
